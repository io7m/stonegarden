...
public interface SGDeviceType extends SGIdentifiableType
{
  ...
  SGDeviceDescriptionType description();

  /**
   * @return The sockets present on the device
   */

  List<SGConnectorSocketType> sockets();

  /**
   * @return The connectors present on the device
   */

  List<SGConnectorType> connectors();
}
