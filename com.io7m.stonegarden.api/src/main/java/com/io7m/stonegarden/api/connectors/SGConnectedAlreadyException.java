...
public final class SGConnectedAlreadyException extends SGException
{
    ...
    final SGConnectorSocketType attempted_socket)
  {
    ...
    return new StringBuilder(128)
      .append("Connector is already connected to a socket.")
      .append(separator)
      .append("  Connector: ")
      ...
      .append(" ")
      .append(existing_socket.protocol().name().value())
      .append(" ")
      ...
      .append(" ")
      .append(attempted_socket.protocol().name().value())
      .append(" ")
    ...
    final SGConnectorType attempted_connector)
  {
    final var separator = System.lineSeparator();
    return new StringBuilder(128)
      .append("Socket is already connected to a connector.")
      .append(separator)
      .append("  Socket: ")
      .append(socket.kind())
      .append(" ")
      ...
      .append(" ")
      .append(existing_connector.protocol().name().value())
      .append(" ")
      ...
      .append(" ")
      .append(attempted_connector.protocol().name().value())
      .append(" ")
